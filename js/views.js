...
const SHOT_MAP_ZONES = [
  ...
  { id: 'two-left-wing', path: 'M65 138H220V323C185 315 150 295 122 264C95 230 75 190 65 138Z' },
  { id: 'two-top', path: 'M220 228H400V323C370 332 340 337 310 337C280 337 250 332 220 323Z' },
  { id: 'two-right-wing', path: 'M400 138H555C545 190 525 230 498 264C470 295 435 315 400 323Z' },
