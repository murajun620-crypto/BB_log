...
const SHOT_MAP_ZONES = [
  ...
  { id: 'two-left-wing', path: 'M65 138H220V228L231 326C227 325 223 324 220 323C185 315 150 295 122 264C95 230 75 190 65 138Z' },
  { id: 'two-top', path: 'M220 228H400L389 326C365 332 340 337 310 337C280 337 255 332 231 326Z' },
  { id: 'two-right-wing', path: 'M400 138H555C545 190 525 230 498 264C470 295 435 315 400 323C396 324 392 325 389 326L400 228Z' },
