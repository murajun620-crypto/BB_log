...
export function aggregateView(s, games, events) {
  ...
  const row = player => `<tr><th scope="row"><button data-action="aggregate-player-detail" data-id="${esc(player.id)}"><b>#${esc(player.number)}</b><span>${esc(player.name)}</span></button></th>${['PTS', 'REB', 'AST', 'STL', 'BLK', 'TO', 'PF'].map(key => cell(player.stats[key], key)).join('')}</tr>`;
...
export function aggregateViewUnified(s, games, events) {
  ...
  const row = player => `<tr><th scope="row"><button data-action="aggregate-player-detail" data-id="${esc(player.id)}"><b>#${esc(player.number)}</b><span>${esc(player.name)}</span></button></th>${['PTS', 'REB', 'AST', 'STL', 'BLK', 'TO', 'PF'].map(key => cell(player.stats, key)).join('')}</tr>`;
  const gameList = games.map(game => {
    const score = aggregate(game, events.filter(event => event.gameId === game.id));
...
const SHOT_MAP_ZONES = [
  ...
  { id: 'two-left-corner', path: 'M65 10H220V170L97.7 228.2C82.9 202.3 71.7 172.8 65 138Z' },
  { id: 'two-left-wing', path: 'M97.7 228.2L220 170V323C185 315 150 295 122 264C113.1 252.8 104.9 240.9 97.7 228.2Z' },
  { id: 'two-top', path: 'M220 228H400V323C370 332 340 337 310 337C280 337 250 332 220 323Z' },
  { id: 'two-right-wing', path: 'M400 170L522.3 228.2C515.1 240.9 506.9 252.8 498 264C470 295 435 315 400 323Z' },
  { id: 'two-right-corner', path: 'M400 10H555V138C548.3 172.8 531.6 216.8 522.3 228.2L400 170Z' },
