...
// The standard shot chart is a 620×475 portrait half-court. Reusing its exact
// line geometry keeps the Pro court symmetric and avoids hand-tuned distortions.
const PRO_HALF_COURT_LINES = '<path d="M10 10H610V465H10ZM65 10V138M555 10V138M65 138C75 190 95 230 122 264C150 295 185 315 220 323C250 332 280 337 310 337C340 337 370 332 400 323C435 315 470 295 498 264C525 230 545 190 555 138M220 10V228H400V10M250 228A60 60 0 1 0 370 228M268 90A42 42 0 0 0 352 90M275 48H345M310 48V56"></path><circle cx="310" cy="70" r="13"></circle><path class="lane-marks" d="M210 70H220M210 112H220M210 154H220M210 196H220M400 70H410M400 112H410M400 154H410M400 196H410"></path>';
const PRO_HALF_COURT_ZONE_BOUNDARIES = '<path d="M10 10H65V138H10ZM10 138H65C75 190 95 230 122 264C150 295 185 315 220 323C223 324 227 325 231 326L92 465H10ZM231 326C255 332 280 337 310 337C340 337 365 332 389 326L528 465H92ZM389 326C392 325 396 324 400 323C435 315 470 295 498 264C525 230 545 190 555 138H610V465H528ZM555 10H610V138H555ZM65 10H220V138H65ZM65 138H220V228L175 306C155.9 295.6 137.8 281.5 122 264C95 230 75 190 65 138ZM220 228H400L445 306C430.4 313.8 415.2 319.5 400 323C370 332 340 337 310 337C280 337 250 332 220 323C204.8 319.5 189.6 313.8 175 306ZM400 138H555C545 190 525 230 498 264C482.2 281.5 464.1 295.6 445 306L400 228ZM400 10H555V138H400ZM220 10H400V228H220ZM268 10H352V90A42 42 0 0 1 268 90Z"></path>';
const PRO_HALF_COURT = `<g class="pro-court-zone-boundaries">${PRO_HALF_COURT_ZONE_BOUNDARIES}</g>${PRO_HALF_COURT_LINES}`;
const PRO_COURT_MARKINGS = `<g transform="matrix(0 0.98021978 0.75333333 0 14.1978022 16.4666667)">${PRO_HALF_COURT}</g><g transform="matrix(0 0.75333333 -0.98021978 0 925.8021978 16.4666667)">${PRO_HALF_COURT}</g>`;
