...
const isPhoneLandscape = () => typeof window !== 'undefined' && window.matchMedia?.('(orientation: landscape) and (max-width: 899px) and (max-height: 500px)').matches;
...
function proCourtHTML(g, events, interactive = false, selectionSide = null) {
  const halfCourt = isPhoneLandscape();
