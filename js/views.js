...
// Zone divisions stay visible for the shot chart, but deliberately recede behind
// official court markings in the live-input view.
const PRO_COURT_ZONE_BOUNDARIES = '<path d="M163 56L242 126L470 24M163 444L242 374L470 476M210 176L274 126M210 324L274 374M777 56L698 126L470 24M777 444L698 374L470 476M730 176L666 126M730 324L666 374"></path>';
const PRO_COURT_MARKINGS = `<g class="pro-court-zone-boundaries">${PRO_COURT_ZONE_BOUNDARIES}</g>${PRO_COURT_MAIN_LINES}`;
