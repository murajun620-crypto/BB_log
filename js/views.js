...
function proShotAreaFeedbackHTML(feedback, halfCourt, attackDirection) {
  ...
  const zone = shotZoneForEvent(feedback);
...
export function shotChartHTML(events, playerId = null, displayMode = 'points', players = [], editable = false) {
